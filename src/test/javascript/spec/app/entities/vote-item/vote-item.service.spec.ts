...
describe('Service Tests', () => {
    ...
    describe('VoteItem Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(VoteItemService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/vote-items';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return VoteItem', () => {

                let entity: VoteItem;
                service.find(123).subscribe((_entity: VoteItem) => {
                    entity = _entity;
                });
